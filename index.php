    ...
    <section class="about-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-pic">
                        <img src="img/photos/IMG_2570.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-text">
                        <h2>NOLA CLUB</h2>
                        <p class="first-para">¡Hola! Soy Caro Kraemer, Fundadora De The Nola Club, Mi Lugar Feliz.
                        </p>

                        <p class="second-para"> Soy Bailarina Desde Hace Más De 20 Años, Egresada De La Licenciatura En Danza, Apasionada Del Movimiento, El Arte Y La Naturaleza.</p>
        ...
        <div class="container" style="padding-top: 5%;">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-pic">
                        <img src="img/photos/IMG_2630.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-text">
                        <p class="first-para">Como Bailarina Siempre Tuve La Necesidad De Entrenar Mi Cuerpo Con Distintas Disciplinas, Buscando Perfeccionar Mi Ejecución En La Danza; <br> <br> Ahí Descubrí Que No Solo Estaba Mejorando Mi Técnica, Sino Que Se Enriquecía Mi Ser A Través Del Movimiento. 
                        </p>
                        
                        <p class="second-para">Nola Es El Cúmulo De Disciplinas Y Experiencias Que Me Mantienen En El Camino Del Amor Propio Y En La Búsqueda Constante De Ser Mi Mejor Versión.
                        </p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-pic">
                        <img src="img/photos/IMG_0179.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="services-item bg-gray">
                                    ...
                                    <h4>Mision</h4>
                                    <p>Ser Un Espacio Seguro Para Una Comunidad Inclusiva De Personas Únicas Que Buscan El Camino Al Amor Propio A Través Del Movimiento.</p>
                                </div>
                                <div class="services-item bg-gray pd-b">
                                    <img src="img/services/service-icon-2.png" alt="">
                                    <h4>Vision</h4>
                                    <p>Lograr La Mejor Versión De Las Personas A Través  Del Movimiento Y De Un Espacio Para Disfrutar Y Alimentar La Mente, El Espíritu Y El Cuerpo.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="services-item item-2 bg-gray pd-b">
                                    <img src="img/services/service-icon-3.png" alt="">
                                    <h4>Valores</h4>
                                    <p>Tolerancia, Respeto, Empatía, Sensibilidad.
                                    </p>
                                </div>
    ...
    <section class="classes-section spad">
        <div class="container">
            ...
            <div class="row classes-slider owl-carousel">
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="img/photos/IMG_2427.jpg">
                        <div class="si-text">
                            <h4>Yoga</h4>
                            <span><i class="fa fa-user"></i> Ryan Knight</span>
                        </div>
                    </div>
                    <div class="single-class-item set-bg" data-setbg="img/photos/IMG_2443.jpg">
                        <div class="si-text">
                            <h4>Karate</h4>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item set-bg" data-setbg="img/photos/IMG_2464.jpg">
                        <div class="si-text">
                            <h4>Running</h4>
    ...
    <section class="membership-section spad">
        <div class="container">
            ...
            <table>
                ...
                <h5>Inscripción: $300</h5> <h5>Clase Suelta: $150</h5>
                        ...
                        <div class="testimonial-slider owl-carousel">
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$370<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                    ...
                                    <a href="#" class="primary-btn membership-btn">Comprar</a>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$600<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                            <p>Clases por Semana</p>
                                            <span>2 Clases</span>
                            ...
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$700<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                            <p>Clases por Semana</p>
                                            <span>3 Clases</span>
                            ...
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$770<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                            <p>Clases por Semana</p>
                                            <span>4 Clases</span>
                            ...
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$870<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                            <p>Clases por Semana</p>
                                            <span>5 Clases</span>
                            ...
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$1000<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                            <p>Clases por Semana</p>
                            ...
                            <div class="col-lg-4">
                                <div class="membership-item">
                                    ...
                                    <h2 class="mi-price">$500<span>MXN</span></h2>
                                    <ul>
                                        <li>
                                            <p>Clases por Semana</p>
                                            <span>Online</span>
