...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/photos/IMG_2611.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <h2>Registrate</h2>
                        <span style="color:#fff">Al registrarte podrás acceder a muchas de nuestras clases de Nola Club</span>
                    </div>
                </div>
            </div>
        </div>
